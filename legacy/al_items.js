...
window.al_items = {};
if(!parent.fail_counts)
{//rn im a bit confused about scopes.
...
function bank_safe(exclude_slots, index, store_any)
{//TODO refactor this to do its thing proper
  index = index || 0;
...
function bank_take()
{//TODO negative numbers as inventory
...
function dump_into_anna(anna_name)
{//TODO dynamic merchant detection
